...
def test_empty_input():
    with pytest.raises(Exception) as e_info:
        generator = GeneratePermutationsFactorialDecomposition([], max_perm_size = 7)
        result = generator.performPermutationGeneration()

def test_too_large_input_str():
    with pytest.raises(Exception) as e_info:
        generator = GeneratePermutationsFactorialDecomposition(["a", "b", "c", "d", "e", "f", "g", "h"], max_perm_size = 7)
        result = generator.performPermutationGeneration()


def test_too_large_input_int():
    with pytest.raises(Exception) as e_info:
        generator = GeneratePermutationsFactorialDecomposition([1, 2, 3, 4, 5, 6, 7, 8], max_perm_size = 7)
        result = generator.performPermutationGeneration()


def test_mixed_str_int_input():
    with pytest.raises(ValueError) as e_info:
        generator = GeneratePermutationsFactorialDecomposition(['A', 'B', 'C', 1, 2, 3], max_perm_size = 7)
        result = generator.performPermutationGeneration()
...
def test_input_size_one_str():
    generator = GeneratePermutationsFactorialDecomposition(["a"], max_perm_size = 7)
    result = generator.performPermutationGeneration()
    assert result == ["a"]
    assert len(result) == 1
...
def test_input_size_one_int():
    generator = GeneratePermutationsFactorialDecomposition([1], max_perm_size = 7)
    result = generator.performPermutationGeneration()
    assert result == [[1]]
    assert len(result) == 1

def test_input_size_three_str():
    generator = GeneratePermutationsFactorialDecomposition(["a", "b", "c"], max_perm_size = 7)
    result = generator.performPermutationGeneration()
...
def test_input_size_three_int():
    generator = GeneratePermutationsFactorialDecomposition([1, 2, 3], max_perm_size = 7)
    result = generator.performPermutationGeneration()
...
def test_input_size_five_str():
    generator = GeneratePermutationsFactorialDecomposition(["a", "b", "c", "d", "e"], max_perm_size = 7)
    result = generator.performPermutationGeneration()
...
def test_input_size_five_int():
    generator = GeneratePermutationsFactorialDecomposition([1, 2, 3, 4, 5], max_perm_size = 7)
    result = generator.performPermutationGeneration()
...
def test_input_size_seven_str():
    generator = GeneratePermutationsFactorialDecomposition(["a", "b", "c", "d", "e", "f", "g"], max_perm_size = 7)
    result = generator.performPermutationGeneration()
...
def test_input_size_seven_int():
    generator = GeneratePermutationsFactorialDecomposition([1, 2, 3, 4, 5, 6, 7], max_perm_size = 7)
    result = generator.performPermutationGeneration()
